...
const TopFlightRouteInternational = () => {
  ...
  const homeData = useSelector(
    (state) => state?.metaData?.allMetaData?.topflightinternational
  );
  return (
        ...
        <div className="row justify-content-center">
          <div className="col-xl-7 col-lg-7">
            <div className="section-title mx-650 mx-auto text-center">
              ...
              <h4 className="title">Top International Flight Route</h4>
            </div>
          </div>
        </div>
        <div className="row">
...
export default TopFlightRouteInternational;
