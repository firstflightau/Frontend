...
const OnewayFilterMobile = ({
  ...
  return (
    <>
      <div className="p-3.5 sm:p-2 lg:p-4 sticky top-28 rounded-lg bg-white border border-gray-200 space-y-4 ">
...
export default OnewayFilterMobile;
